...
<head>
    ...
    <title>Mỹ Phẩm Sunshine Chính Hãng | An Nhii Shop</title>

    <!-- Bootstrap Core CSS -->
    <link href="{{asset('Store/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset('Store/vendor/fontawesome/css/font-awesome.min.css') }}" type="text/css" rel="stylesheet">
    <link href="{{ asset('Store/vendor/animateit/animate.min.css') }}" rel="stylesheet">
    
    <!-- Vendor css -->
    <link href="{{ asset('Store/vendor/owlcarousel/owl.carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('Store/vendor/magnific-popup/magnific-popup.css') }}" rel="stylesheet">

    <!-- Template base -->
    <link href="{{ asset('Store/css/theme-base.css') }}" rel="stylesheet">

    <!-- Template elements -->
    <link href="{{ asset('Store/css/theme-elements.css') }}" rel="stylesheet">
    ...
    <!-- Template color -->
    <link href="{{ asset('css/color-variations/blue.css') }}" rel="stylesheet" type="text/css" media="screen" title="blue">

    <!-- LOAD GOOGLE FONTS -->
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,800,700,600%7CRaleway:100,300,600,700,800" rel="stylesheet" type="text/css" />
    {{ asset('Store/') }}
    <!-- SLIDER REVOLUTION 5.x CSS SETTINGS -->
    <link rel="stylesheet" property="stylesheet" href="{{ asset('Store/vendor/rs-plugin/css/settings.css') }}" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('') }}Store/css/rs-plugin-styles.css" type="text/css" />

    <!-- CSS CUSTOM STYLE -->
    <link rel="stylesheet" type="text/css" href="{{ asset('Store/css/custom.css') }}" media="screen" />

    <!--VENDOR SCRIPT-->
    <script src="{{ asset('Store/vendor/jquery/jquery-1.11.2.min.js') }}"></script>
    <script src="{{ asset('Store/vendor/plugins-compressed.js') }}"></script>
    
    <!-- SLIDER REVOLUTION 5.x SCRIPTS  -->
    <script type="text/javascript" src="{{ asset('Store/vendor/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('Store/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
...
<body class="wide">
                ...
                <div class="container">
                    ...
                    <div id="logo">
                        <a href="index.html" class="logo" data-dark-logo="images/logo-dark.png">
                            <img src="{{ asset('Store/images/logo.png') }}" alt="Polo Logo">
                        </a>
                    </div>
                    <!--END: LOGO-->
                ...
                <div id="rev_slider_30_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.1">
                    <ul>
                        ...
                        <li data-index="rs-130" data-transition="notransition" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slider/notgeneric_bg3-180x100.jpg" data-rotate="0" data-saveperformance="off" data-title="WORLD OF POLO" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('Store/') }}images/slider/dummy.png" alt="" width="1920" height="1080" data-lazyload="images/slider/notgeneric_bg3.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
    ...
    <script src="{{ asset('Store/js/theme-functions.js') }}"></script>
